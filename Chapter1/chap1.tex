...
{\large
	The second chapter (Technical Fundamentals),  covers  the choosen technolgies like Programming language and IDE of choice and the used versions. Aswell as an short introduction into the Android Architecture, specifically the Java Framework API.
	Chapter 2 provides a valuable insight into the core functionallity of the operating system, making it easier to understand the implementation. Chapter three discusses the Functional Requirements , by breaking it down into multiple sub requirements.  These requirements will be taken up again in chapter four, where they are translated into code.  
}
