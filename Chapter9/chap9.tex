...
fun drawFlowingGraph() {
	...
	\paragraph{Draw recorded EKG-Data}\mbox{}\\
	\mbox{}\\
	...
	\begin{lstlisting}[label={fig:simpleSourceGen.cs}, caption={Einfaches Beispiel eines Sourcecode-Generators, abgeleitet von \cite{microsoft_roslyndocsfeaturesincremental-generatorsmd_2024, carter_introducing_2020} und eigenen Ergänzungen}]
		.pointerInput(Unit) {
			...
			detectTapGestures (onDoubleTap = {
				...
				println("This is where i tapped: "  + tappedPointer)
				currentTappedPointerIndexBPM = (relativeTap * currentBPMList.size).toInt() //sublist Index
				tappedPointerIndexBPM =  currentTappedPointerIndexBPM + fromIndexBPM // original List Index
				
				println("INDEX IN ARRAY: " + tappedPointerIndexBPM)
