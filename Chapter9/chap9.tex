...
\begin{flushleft}
		...
		\begin{center}
			...
			\centering
			\begin{tabular}{l| p{0.4\textwidth}} % <-- Alignments: 1st column left, 2nd middle and 3rd right, with vertical lines in between
				\textbf{Layer} & \textbf{Functionality} \\
				\hline
				
				
				BLEViewModel & 	\begin{itemize}
					\item Communication with the microcontroller
					\item Receives datastream
					\item Sends instructions to microcontroller
				\end{itemize}\\
				\hline
